...
const STARTERS = [
  ...
  "What should I prepare for my shoot?",
  "How do I track my booking status?",
  "What types of photography do you offer?",
];

export default function ClientAiSupportPage() {
    ...
    <div className="max-w-3xl mx-auto px-4 py-6 flex flex-col h-[calc(100vh-8rem)]">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-0.5">Ask me anything about your bookings, gallery, downloads, and your photo journey</p>
        </div>
        {messages.length > 0 && (
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-zinc-500 mt-1">I know the platform inside and out — bookings, galleries, payments, and more.</p>
            </div>
